...
***Note:*** no action stated in below petitions will replace the irrevocable demands and terms set by Alghuti (will be published in file 9 of 9). If it is found that the conduct of attorney’s, judges, other officers involved in this case (documents 1 through 9) is considered "legal", it is evidence of an illegitimate legal system, and it is a duty to abolish it entirely.  

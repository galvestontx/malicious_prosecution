...
***Note:*** the false testimony submitted by persons named in the above [document](https://drive.google.com/file/d/1e-7dWshR_VGjhiRWMwYHnGV6fxh7-knF/view?usp=drivesdk) is of little concern (as it is expected), my primary concern is the government response. I do not, nor will i ever, grant jurisdiction to the court (or to any person) over matters concerning religious law, my duty, my household, or any item or person under my trust. That said, sanctions will be published for public view since this court failed to resolve matters privately.

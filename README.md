...
***Note:*** (assuming the court has jurisdiction over the cases) matters concerning the marriage as well as the fraudulent charges made against Hatem Alghuti are nothing more than a distraction from the real matters which this criminal case aims to conceal (refer to File 9 of 9).
